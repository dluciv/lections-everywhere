...
print(dict(classify_lineary(k, {"мясо": 4/7, "рыба": 3/7})))
print(dict(classify_lineary(k, {"потроха": 1/6, "репа": 5/6})))
...
```
{'мясоед': 0.3333333333333333, 'умеренный вегетерианец': 0.14285714285714285, 'веган': 0.0}
{'мясоед': 0.05555555555555555, 'умеренный вегетерианец': 0.2777777777777778, 'веган': 0.2777777777777778}
```
...
```
print(dict(classify(k, {"мясо": 4/7, "рыба": 3/7})))
print(dict(classify(k, {"потроха": 1/6, "репа": 5/6})))
